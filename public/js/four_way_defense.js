let game = new Phaser.Game(600, 600, Phaser.AUTO, '', { preload: preload, create: create, update: update });
...
function create() {
  ...
  messageDisplay = game.add.text(150, 500, 'Press spacebar to start', {fontSize: '32px', fill: '#000'})

  rulesDisplay = game.add.text(60, 550, 'Use the arrow keys to defend the star', {fontSize: '32px', fill: '#000'})
